...
public interface CryptoService {
     ...
     * @param year
     * @param month
     * @return Map<String, List < { @ link Crypto }> containing statistic name(min/max/newest/oldest} and the list of {@link Crypto}
     */
    Map<String, List<Crypto>> getStatisticsByMonthAndYear(Integer year, Integer month) throws InvalidDateException;

    /**
     * Compute a {@link List} of {@link Pair}s of statistic name and desired {@link Crypto} statistic name and the list of crypto for it
     *
